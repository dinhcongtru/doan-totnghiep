                                            ...
                                            <tbody class="updateItem">
                                                <tr class="clearfix line-item-container">
                                                    ...
                                                    <td class="item itemVariantCart">
                                                        ...
                                                        <h3>
                                                            <a>
                                                                Áo Sơ Mi Cổ Pizama Cộc Tay Classic 3000 - Xanh - M
                                                            </a>
                                                        </h3>
                                                        <p></p>
                                                        <div class="visible-xs showInMobileCart clearfix">
                                                            <div class="qty quantity-partent qty-click clearfix">
                                                                ...
                                                                <input type="text" size="4" min="1" id="" max="15" value="1" data-id="37883750" class="tc line-item-qty item-quantity" readonly="">
                                                                <span class="add-up add-action">+</span>
                                                            </div>
                                                            <span class="line-item-total">349,000₫</span>
                                                        </div>
                                                        <a class="deleteItem cart_remove cart_remove_index">Xóa</a>
                                                    </td>
                                                    <td class="hidden-xs quantity quantityVariantCart">
                                                        <div class="qty quantity-partent qty-click clearfix">
                                                            <span class="add-down add-action">-</span>
                                                            <input type="text" size="4" min="1" max="15" value="1" class="tc line-item-qty item-quantity" readonly="">
                                                            <span class="add-up add-action">+</span>
                                                        </div>
                                                    </td>
                            ...
                            <div class="boxRightCart clearfix">
                                ...
                                <div class="summary-subtotal clearfix">
                                    ...
                                    <p class="order-infor boldPrice">
                                        ...
                                        <span class="valOrder total_price"><b>349,000₫</b></span>
                                    </p>
                                </div>
                                ...
                                <div class="cart-buttons">
                                    <a id="checkout" name="checkout" class="checkLimitCart">Tiến hành đặt hàng</a>
                                    <a class="link-continue" title="Tiếp tục mua hàng">Mua thêm sản phẩm</a>
                                </div>
                            </div>
                        </div>
                    </form>
